<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciPdfBilgileri.aspx.cs" Inherits="WebApplication4.KullaniciPdfBilgileri" %>
...
<body class="body">
    <form id="form1" runat="server">
        <h1 class="baslik" >KULLANICI PDF BİLGİLERİ</h1>
            ...
            <div class="auto-style2">
                ...
                &nbsp;&nbsp;<asp:DataList ID="DataList1" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" GridLines="Both" Width="100%" Height="500px" CssClass="ortala">
                    ...
                    <ItemTemplate>
                        <table class="auto-style7">
                            <tr>
                                <td class="auto-style8"><%# Eval("PdfID")%></td>
                                <td class="auto-style9"><%# Eval("YazarBilgileri")%></td>
                                <td class="auto-style10"><%# Eval("DersAdi")%></td>                              
                                <td class="auto-style9"><%# Eval("ProjeninTeslimEdildigiDonem")%></td>
                                <td class="auto-style9"><%# Eval("ProjeBasligi")%></td>
                                <td class="auto-style11"><%# Eval("AnahtarKelimeler")%></td>
                                <td class="auto-style9"><%# Eval("DanismanBilgiler")%></td>
                                <td class="auto-style11"><%# Eval("JuriBilgileri")%></td>
                            </tr>
                        </table>
                    </ItemTemplate>
