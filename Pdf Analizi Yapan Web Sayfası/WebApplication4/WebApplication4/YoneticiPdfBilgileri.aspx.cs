...
namespace WebApplication4
{
    ...
    public partial class YoneticiPdfBilgileri : System.Web.UI.Page
    {
        ...
        public string JuriBilgileriAra(string metin)
        {
            ...
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where YazarBilgileri like'" + TextBox1.Text + "%'", sqlCon);
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where DersAdi like'" + TextBox2.Text + "%'", sqlCon);
        ...
        {
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where ProjeninTeslimEdildigiDonem like'" + TextBox4.Text + "%'", sqlCon);
        ...
        {
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where ProjeBasligi like'" + TextBox5.Text + "%'", sqlCon);
        ...
        {
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where  AnahtarKelimeler like'" + TextBox6.Text + "%'", sqlCon);
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            ...
            sqlCon.Open();
            SqlCommand komut2 = new SqlCommand("Select * From YoneticiPdfBilgileri Where DanismanBilgiler like'" + TextBox7.Text + "%'", sqlCon);
